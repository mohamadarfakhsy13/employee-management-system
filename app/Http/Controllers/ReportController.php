...
class ReportController extends Controller
{
    ...
    private function getExportingData($constraints) {
        ...
        ->select('employees.firstname', 'employees.lastname', 'employees.email', 'employees.age', 'employees.birthdate', 'employees.address', 'employees.zip', 'employees.date_hired', 'department.name as department_name', 'division.name as division_name')
